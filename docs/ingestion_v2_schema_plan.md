...
- **Vietcap IQ financial statements / FA data** are a separate source-discovery gate after the controlled OHLCV proof; no statement endpoint, row-level sample, parser, DB write, or backtest exists yet.
