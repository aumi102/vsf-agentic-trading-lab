...
12. Integrate a verified adjusted-close or corporate-action source adapter for a small explicit symbol set, then use the local factor application path before Backtrader VN100 runs.
