...
- [x] FA metric mapping re-probe succeeded (run `20260610T025420Z`, HTTP 200): 1078 metric codes across 4 sections; coverage 62.8% BS / 43.6% IS / 65.8% CF — below 95% DB write gate threshold; mapping dry-run parser added (50 tests); see `docs/data_sources/vietcap_iq_fa_mapping_cashflow_probe.md`.
