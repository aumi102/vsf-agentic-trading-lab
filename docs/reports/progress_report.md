...
- [ ] Metric mapping partially retrieved — union coverage BS 89.4% / IS 92.3% / CF 86.7% — below 95% gate threshold; `line_item_name` integration into parser not yet implemented; `line_item_name` empty for all parsed rows.
