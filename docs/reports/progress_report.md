...
| Reviewed adjusted price local execute readiness tests | 11 targeted tests |
...
12. Use the real adjusted-price evidence onboarding workflow to generate a manifest, validation JSON, human-readable dry-run report, and local execute-readiness report for manually provided FPT/VNM/VCB evidence before any Backtrader VN100 work.
