...
12. Use the real adjusted-price evidence onboarding workflow to generate a manifest, validation JSON, and human-readable dry-run report for manually provided FPT/VNM/VCB evidence before any Backtrader VN100 work.
