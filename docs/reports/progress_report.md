...
| Reviewed adjusted price evidence intake | Local JSON/CSV intake validates source, raw path, reviewer, review timestamp, evidence basis, and price rows before factor generation or optional local execute. No live fetch, full VN100, or Backtrader. |
...
| Reviewed adjusted price evidence intake tests | 22 targeted tests |
...
12. Use reviewed adjusted-price evidence intake for FPT/VNM/VCB, then keep Backtrader VN100 blocked until adjusted readiness passes on reviewed evidence.
