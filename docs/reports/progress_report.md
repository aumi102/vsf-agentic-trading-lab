...
- Main blocker: FA metric mapping coverage below 95% gate and conflicts require integration strategy to be implemented; `publicDate` PIT validation; full-history FA fetch not implemented; DB write blocked; backtest blocked.
