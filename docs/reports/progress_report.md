...
| Adjusted OHLC backtest feed contract | Read-only small-symbol contract and preview maps adjusted OHLC to feed price fields only after strict audit passes. No Backtrader implementation or strategy execution. |
...
| Adjusted OHLC backtest feed readiness tests | 18 targeted tests |
