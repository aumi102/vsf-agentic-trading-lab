...
def write_source_probe_report(
    *,
    ...
    lines = [
        ...
        "## Source Summary",
        "",
        "| Source | Target | Access status | Auth status | Endpoint or surface | Observed fields | Row count | Likely canonical tables | Raw paths | Skipped reason | Missing auth env | Terms notes | Next action |",
        "|---|---|---|---|---|---|---:|---|---|---|---|---|---|",
    ]
